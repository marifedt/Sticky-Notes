...
const btnGen = document.querySelector(".btn-info");
const quote = document.querySelector("#quote");
const author = document.querySelector("#author");
const prof = document.querySelector("#profession");


//Function to Generate the Quotes from the Array.
const genQuote = function(){
// Random number based on how many items is on the array.
var rndIndex = Math.floor(Math.random()* quotesArr.length);

quote.innerHTML = `&ldquo; ${quotesArr[rndIndex]["quote"]} &rdquo;`
author.innerHTML = `-${quotesArr[rndIndex]["author"]}`
prof.innerHTML = `&#40; ${quotesArr[rndIndex]["profession"]}  &#41;`
}

btnGen.addEventListener('click', genQuote);